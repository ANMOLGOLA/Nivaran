...
const QUICK_ACTIONS = [
  { icon: MapPin, label: 'Report Issue', desc: 'File civic complaints instantly', href: '/report', color: '#FF9933', bg: 'rgba(255,153,51,0.1)', img: 'https://picsum.photos/id/1048/400/300' },
  { icon: HeartHandshake, label: 'Govt Schemes', desc: 'Find benefits you are eligible for', href: '/schemes', color: '#138808', bg: 'rgba(19,136,8,0.1)', img: 'https://picsum.photos/id/119/400/300' },
  { icon: BarChart3, label: 'City Dashboard', desc: 'Track local resolution metrics', href: '/public-dashboard', color: '#0B1F3A', bg: 'rgba(11,31,58,0.08)', img: 'https://picsum.photos/id/164/400/300' },
];
...
export const DashboardHome: React.FC<Props> = ({ user }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      ...
      >
        <img 
          src="https://picsum.photos/id/1040/1600/600" 
          alt="India Heritage" 
